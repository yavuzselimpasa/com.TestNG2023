...
public class  C03_SoftAssertion {
    ...
    public void hardAssertion(){
     ...
     --> Eger bir test method'u icinde birden fazla Assert islemi varsa,
         ilk failed gerceklestiginde Selenium calismayi durdurur sonraki assertion'lar calismamis olur
         ve soyle hata firlatir: "java.lang.AssertionError"
